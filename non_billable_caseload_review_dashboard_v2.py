...
# ----------------------------
# Bottom Follow-Up Lists
# ----------------------------
st.markdown("## Printable Follow-Up Lists")
...
with bottom_col1:
    ...
    st.download_button(
        label="Export Attempt Only / No Contact List",
        data=make_excel_download({"Attempt Only No Contact": attempt_summary}),
        file_name="Attempt_Only_No_Contact_List.xlsx",
        mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
        key="download_attempt_bottom",
    )
...
with bottom_col2:
    ...
    st.download_button(
        label="Export No Engagement / No Contact List",
        data=make_excel_download({"No Engagement No Contact": no_engagement_list}),
        file_name="No_Engagement_No_Contact_List.xlsx",
        mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
        key="download_no_engagement_bottom",
    )
